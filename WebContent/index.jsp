...
<
        <div class="row">
            <!-- Team member -->
            <jsp:useBean id="PS" class="Dao.TiendaDao" scope="request"></jsp:useBean>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="card-title"><c:out value="${p.nombre}"/></h4>
                                    <p class="card-text"><c:out value="${p.lema}"/></p>
                        ...
                        <div class="backside">
                            <div class="card">
                                <div class="card-body text-center mt-4">
                                    <h4 class="card-title"><c:out value="${p.propietario}"/></h4>
