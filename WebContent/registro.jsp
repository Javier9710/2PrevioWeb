...
<body>
	...
	<div id="login">
		<h3 class="text-center text-white pt-5">FORMULARIO DE REGISTRO</h3>
		<div class="container">
			<div id="login-row"
						...
						<form id="login-form" class="form" action="EstudianteControl" method="post">
							...
							<div class="form-group">
								<label for="username" class="text-info">Usuario:</label> <input
									type="text" value="" name="usuario" id="username" class="form-control">
							</div>

							<div class="form-group">
								<label for="username" class="text-info">Nombre:</label> <input
									type="text" value="" name="nombre" id="username" class="form-control">
							</div>
							...
							<div class="form-group">
								...
								<div id="register-link" class="text-right">
									<br>
									<br> <a href="index.jsp" class="text-info">Login</a><br>
								</div>
							</div>
